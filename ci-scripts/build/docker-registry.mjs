...
export function dockerBuildPush({ project, env, versionTag, registryTag = versionTag, buildArgs = {}, ssh, imagePath, dockerfilePath, contextDir, extraTags = [] }) {
  ...
  return impl.dockerBuildPush({ namespace, env, versionTag, registryTag, buildArgs, ssh, imagePath, dockerfilePath: file, contextDir: context, extraTags });
}
