...
Once real C# utilities land in this kit, document their conventions here
(the same way `tanstack/conventions/CLAUDE.md` and
`nestjs/conventions/CLAUDE.md` do for their own ecosystems) — folder
layout, naming, what's generic vs. project-specific.
